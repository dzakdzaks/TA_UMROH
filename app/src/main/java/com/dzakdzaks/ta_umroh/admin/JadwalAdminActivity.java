...
import com.dzakdzaks.ta_umroh.home.JadwalActivity;
...
public class JadwalAdminActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void getJadwal() {
        ...
        Call<ResponseTiket> call = apiService.getAllTiket(id);
        call.enqueue(new Callback<ResponseTiket>() {
            ...
            public void onResponse(Call<ResponseTiket> call, Response<ResponseTiket> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(JadwalAdminActivity.this, "Semua Jadwal Keberangkatan", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseTiket> call, Throwable t) {
                Toast.makeText(JadwalAdminActivity.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
